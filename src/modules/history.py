...
class ChatHistory:
    ...
    def initialize_assistant_history2(self, file_name):
        st.session_state["assistant"] = [self.default_prompt(file_name)]
    ...
    def initialize2(self, file_name):
        if "assistant" not in st.session_state:
            self.initialize_assistant_history2(file_name)
        if "user" not in st.session_state:
            self.initialize_user_history()
